"""
UNet-256 Model Configuration for Stage 2 Fine-tuning
Enhanced UNet architecture with EMA for improved convergence
"""
...
class UNet256(nn.Module):
    ...
    - 256 base channels instead of 320
...
def create_unet256() -> UNet256:
    """Create UNet-256 model with production settings"""
    return UNet256(
        in_channels=4,
        out_channels=4,
        model_channels=256,
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        print("✓ UNet-256 forward pass successful")
